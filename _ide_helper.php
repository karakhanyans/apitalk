 ...
 * Generated for Laravel 5.7.19 on 2018-12-25 07:35:38.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function api($success, $data, $errors, $statusCode)
        {
            return \Illuminate\Routing\ResponseFactory::api($success, $data, $errors, $statusCode);
        }
